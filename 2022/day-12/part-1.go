...
func main() {
	...
	for unvisitedNodes > 0 {
		...
		// If current distance + 1 is less than their distance, update their distance
	...
	coordsE := getNodeCoordinates(nodeKeyOfE)
	shortestDistanceToE := distances[coordsE[0]][coordsE[1]]
	fmt.Println("Shortest distance to E:", shortestDistanceToE)
}
